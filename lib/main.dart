...
void main() {
  runApp(MaterialApp(home: tiktoy(),));
}

class tiktoy extends StatefulWidget {
  const tiktoy({Key? key}) : super(key: key);

  @override
  State<tiktoy> createState() => _tiktoyState();
}

class _tiktoyState extends State<tiktoy> {
  @override
    ...
    return Expanded(child: InkWell(
      onTap: (l[i] == "" && winner == false) ? () {
        ...
        setState(() {});
          ...
          :null,
      child: Container(
        color: l[i] == "" ? Colors.blueGrey : (l[i] == p1
            ? Colors.orangeAccent
            : Colors.lightGreen),
